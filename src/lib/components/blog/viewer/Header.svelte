...
<header class="w-full px-0 mb-10 min-[980px]:pt-10">
    <div class="w-full max-w-[653px] mx-auto">
        ...
        {#if subtitle}
            <p class="text-[21px] leading-[25px] lg:text-[24px] lg:leading-[28px] text-[#1d1d1f] dark:text-[#f5f5f7] font-medium mt-5">
                {subtitle}
            </p>
        {/if}
    ...
    {#if cover}
        <LazyImage
            src={cover} 
            alt={title}
            class="block w-full max-w-[850px] h-auto mx-auto mt-[14px] rounded-[10px]"
            width="100%"
            height="auto"
