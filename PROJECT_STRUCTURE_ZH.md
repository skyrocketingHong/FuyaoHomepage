...
│   └── albums/           # 空媒体目录和版本化元数据
├── CONFIGURATION.md      # 英文配置与部署文档
├── CONFIGURATION_ZH.md   # 简体中文配置与部署文档
├── LICENSE               # 项目许可证
├── MIGRATION_3_TO_27.md     # 英文 3.0.0 至 27.0 迁移手册
├── MIGRATION_3_TO_27_ZH.md  # 简体中文迁移手册
├── PROJECT_STRUCTURE.md     # 英文项目结构说明
├── PROJECT_STRUCTURE_ZH.md  # 简体中文项目结构说明（本文档）
├── README.md             # 默认英文项目自述文件
├── README_ZH.md          # 简体中文项目自述文件
...
> **提示**：新增、修改代码文件或目录后，必须同步更新 `PROJECT_STRUCTURE.md` 与 `PROJECT_STRUCTURE_ZH.md`。
